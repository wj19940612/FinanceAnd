                ...
                switch (type) {
                    ...
                    case LeaderBoardRank.PROFIT:
                        if (item.getWorshipCount() > 0) {
                            mIngot.setText(StrUtil.mergeTextWithColor(context.getString(R.string.ingot_number_no_blank, Math.floor(item.getScore())),
                                    " +" + context.getString(R.string.ingot_number_no_blank, item.getWorshipCount())
                                    , ContextCompat.getColor(context, R.color.unluckyText)));
                        } else {
                            mIngot.setText(context.getString(R.string.ingot_number_no_blank, Math.floor(item.getScore())));
                        }
                        break;
                    case LeaderBoardRank.SAVANT:
                        if (item.getWorshipCount() > 0) {
                            mIngot.setText(StrUtil.mergeTextWithColor(context.getString(R.string.integrate_number_no_blank, String.valueOf(Math.floor(item.getScore()))),
                                    " +" + context.getString(R.string.ingot_number_no_blank, Math.floor(item.getWorshipCount()))
                                    , ContextCompat.getColor(context, R.color.unluckyText)));
                        } else {
                            mIngot.setText(context.getString(R.string.integrate_number_no_blank, String.valueOf(Math.floor(item.getScore()))));
                        }
                        break;
                }
            }
