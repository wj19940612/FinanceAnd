 ...
 * 对战分享好友弹框
 */
public class ShareReportDialogFragment extends DialogFragment {
    ...
    public static ShareReportDialogFragment newInstance() {
        ShareReportDialogFragment fragment = new ShareReportDialogFragment();
        return fragment;
    }

    public ShareReportDialogFragment setShareMode(boolean isFutureGame) {
        this.isFutureGame = isFutureGame;
        return this;
    }

    public ShareReportDialogFragment setShareContent(String shareTitle, String shareDescription, String batchCode) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.dialog_fragment_report_share, container, false);
    ...
    public void show(FragmentManager manager) {
        this.show(manager, ShareReportDialogFragment.class.getSimpleName());
    }
