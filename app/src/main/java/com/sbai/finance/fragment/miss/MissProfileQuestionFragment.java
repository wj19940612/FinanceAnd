...
public class MissProfileQuestionFragment extends BaseFragment implements MissAudioManager.OnAudioListener {
...
//        mSet.clear();
    ...
    //其他界面跳转回来
    public void dealOtherActivityResule(int reqQuestionDetail, Intent data) {
        if (reqQuestionDetail == REQ_QUESTION_DETAIL && data != null) {
