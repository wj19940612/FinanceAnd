...
public class StockRTDataModel implements Parcelable {
    ...
    public StockRTDataModel() {
    }

    protected StockRTDataModel(Parcel in) {
    ...
    public static final Parcelable.Creator<StockRTDataModel> CREATOR = new Parcelable.Creator<StockRTDataModel>() {
        @Override
        public StockRTDataModel createFromParcel(Parcel source) {
            return new StockRTDataModel(source);
        }

        @Override
        public StockRTDataModel[] newArray(int size) {
            return new StockRTDataModel[size];
        }
    };
}
