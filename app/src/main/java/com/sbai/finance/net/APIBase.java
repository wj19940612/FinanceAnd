...
//    private final static String HOST = "http://gf2.dajiexin.com";
    ...
    public APIBase(String uri, ApiParams apiParams) {
        this(Request.Method.GET, uri, apiParams, 0);
    }

    public APIBase(int method, String uri, ApiParams apiParams) {
        this(method, uri, apiParams, 0);
    }

    public APIBase(String uri, ApiParams apiParams, int version) {
        this(Request.Method.GET, uri, apiParams, version);
    }

    public APIBase(int method, String uri, ApiParams apiParams, int version) {
        mUri = uri;
