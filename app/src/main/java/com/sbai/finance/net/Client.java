...
public class Client {
	 ...
	 * @return
	 */
	public static API getHistoryNews(String classify, boolean autoRead, Integer page, Integer size, Integer status, Long createTime) {
		return new API(POST, "/msg/msg/history.do", new ApiParams()
