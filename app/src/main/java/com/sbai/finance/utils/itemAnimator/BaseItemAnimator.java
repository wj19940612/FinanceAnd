package com.sbai.finance.utils.itemAnimator;
...
/**
 * Created by ${wangJie} on 2017/8/1.
 */
...
//            Log.d("wangjie", "DISAPPEARING: " + viewHolder + " with view " + disappearingItemView);
//            return animateMove(viewHolder, oldLeft, oldTop, newLeft, newTop);
//        } else {
//            Log.d("wangjie", "REMOVED: " + viewHolder + " with view " + disappearingItemView);
...
//    }
    ...
    public boolean animatePersistence(@NonNull ViewHolder viewHolder, @NonNull ItemHolderInfo preInfo, @NonNull ItemHolderInfo postInfo) {
        if (preInfo.left != postInfo.left || preInfo.top != postInfo.top) {
            Log.d("wangjie", "PERSISTENT: " + viewHolder +
                    " with view " + viewHolder.itemView);
            return animateMove(viewHolder,
                    preInfo.left, preInfo.top, postInfo.left, postInfo.top);
        }
        Log.d("wangjie", "animatePersistence: " + super.animatePersistence(viewHolder, preInfo, postInfo));
